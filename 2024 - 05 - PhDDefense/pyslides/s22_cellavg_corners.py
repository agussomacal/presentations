...
from PhDDefense.pyslides.s20_cellavg_aeros import aeros_stencil_animation_objects, STENCIL_STROKE_WIDTH, \
...
path_corners_images = Path(
    os.path.join(os.path.abspath(__file__).split("PhDDefense")[0], "PhDDefense", "Material", "SubCell", "Corners",
