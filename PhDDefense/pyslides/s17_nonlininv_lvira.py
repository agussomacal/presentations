...
from PhDDefense.pyslides.s14_nonlininv_near_optimality import best_fit_estimator, near_optimality_property, \
...
from PhDDefense.pyslides.s16_nonlininv_piecewise_constant import LVIRA_COLOR, LVIRA_DATA, \
    create_convergence_plot_objects
from PhDDefense.pyslides.s20_cellavg_aeros import get_scale_from_desired_width, GRID_COLOR, CELL_T_COLOR, \
    grid_averages
