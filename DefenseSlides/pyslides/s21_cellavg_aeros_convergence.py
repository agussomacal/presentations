...
from DefenseSlides.pyslides.s16_nonlininv_piecewise_constant import create_convergence_plot_objects, \
    AEROS_4_DATA, AEROS_2_DATA
from DefenseSlides.pyslides.s20_cellavg_aeros import AEROS_COLOR
from config import *
