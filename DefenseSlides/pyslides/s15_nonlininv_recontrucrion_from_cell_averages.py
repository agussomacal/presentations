...
from pyslides.s04_intro_two_problems import num_cells_per_dim
from lib.utils import MySlide, move_and_scale, shift_to

path_subcell = Path(
    os.path.join(os.path.abspath(__file__).split("DefenseSlides")[0], "DefenseSlides", "Material", "SubCell"))
