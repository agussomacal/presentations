...
from DefenseSlides.pyslides.s14_nonlininv_near_optimality import best_fit_estimator, near_optimality_property, \
...
from DefenseSlides.pyslides.s15_nonlininv_recontrucrion_from_cell_averages import ConvergencePLotLayout, \
    latex4average_measurements, get_original_data_and_ground_truth, get_reconstructions
from DefenseSlides.pyslides.s16_nonlininv_piecewise_constant import LVIRA_COLOR, LVIRA_DATA, \
    create_convergence_plot_objects
from DefenseSlides.pyslides.s20_cellavg_aeros import get_scale_from_desired_width, GRID_COLOR, CELL_T_COLOR, \
    grid_averages
from lib.utils import create_grid, cmap_value2manimcolor, create_grid_of_colored_rectangles, MySlide, get_sub_objects, \
    get_shift_from_xy_coordinate
