...
from DefenseSlides.pyslides.s20_cellavg_aeros import aeros_stencil_animation_objects, STENCIL_STROKE_WIDTH, \
    STENCIL_COLOR, get_scale_from_desired_width, GRID_COLOR, CELL_T_COLOR
from lib.utils import MySlide, create_column_grid, create_column_rectangles, create_grid

path_corners_images = Path(
    os.path.join(os.path.abspath(__file__).split("DefenseSlides")[0], "DefenseSlides", "Material", "SubCell", "Corners",
                 "imageShapesVertexjpg"))
