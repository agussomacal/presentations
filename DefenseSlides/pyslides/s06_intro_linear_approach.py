...
from DefenseSlides.pyslides.s04_intro_two_problems import get_Yshape_object, DOMAIN_FILL_OPACITY
from DefenseSlides.pyslides.s05_intro_solution_manifold import buff_images, solution_manifold, \
    linear_approx
