...
<img src="../figures/handmade/FunctionApproximation.png" width="300">
</div>
...
$$\color{white}\text{Approximation} \\ \text{manifold}$$
$$\color{white}\cM :=\{v_\theta(x)=A(\theta)(x);\; \theta\in\R^p\}$$
$$\color{white}\text{Linear model,} \\ \text{Neural network,}\\...$$
</div>
